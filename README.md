...
> **⚠️ 서버 운영 안내**
> 현재 해커톤 종료 후 서버 비용 문제로 **서비스가 중단된 상태**입니다.
> 서비스 체험은 아래 **[시연 영상](#시연-영상)** 과 **[서비스 화면](#서비스-화면)** 을 참고해 주세요!

### 왜 Focus Timer인가?

| 기존 뽀모도로 | Focus Timer |
|:------------:|:-----------:|
| 모두에게 25분 강요 | 개인별 최적 시간 AI 추천 |
...
- 집중 시간을 얼마로 설정해야 할지 모르겠는 분
- 뽀모도로 25분이 너무 길거나 짧게 느껴지는 분
- 자신의 집중 패턴을 데이터로 파악하고 싶은 분
- 게이미피케이션으로 동기부여가 필요한 분
...
[![Focus Timer 시연 영상](https://img.youtube.com/vi/yfmO5ZvG9Gs/maxresdefault.jpg)](https://www.youtube.com/watch?v=yfmO5ZvG9Gs)

**▶️ 위 이미지를 클릭하면 YouTube에서 시연 영상을 볼 수 있습니다**
...
| 레벨 | 이름 | 필요 업적 수 | 캐릭터 |
|-----|------|------------|--------|
| Lv.1 | 새싹 | 0개 | 픽셀아트 검은 고양이 |
| Lv.2 | 초보자 | 5개 | 레벨 2 고양이 |
| Lv.3 | 수련생 | 15개 | 레벨 3 고양이 |
| Lv.4 | 집중러 | 30개 | 레벨 4 고양이 |
| Lv.5 | 마스터 | 50개 | 레벨 5 고양이 |
